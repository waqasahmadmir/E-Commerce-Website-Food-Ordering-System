...
<div class="container">
  ...
  <form action="{{url('/reseting_password',$item->id)}}" method="POST" style="margin-top: 2px ; margin-left:300px">
  @csrf
  <div class="form-group">
    <label for="name">User Name</label>
    <input type="text" class="form-control" id="name" name="name" aria-describedby="emailHelp" value="{{$item->name}}" required style="width: 400px;"  readonly>
  </div>

  <div class="form-group">
    <label for="email">Email address</label>
    <input type="email" class="form-control" id="email" name="email"  aria-describedby="emailHelp" value="{{$item->email}}" style="width: 400px;" readonly required>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control"  name="password2" id="password" placeholder="Password again" style="width: 400px;" required>
  </div>
