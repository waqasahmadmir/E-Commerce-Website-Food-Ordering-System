            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a class="nav-link" href="{{url('order')}}" style="font-size: 18px;">Home <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('services')}}" style="font-size: 18px;">Services</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('orderitems',$check->id)}}" style="font-size: 18px;">Menu</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('aboutapp')}}" style="font-size: 18px;">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('contactus')}}" style="font-size: 18px;">Contactus</a>
                    </li>

                    
                    <li class="nav-item">
                        <a style="float: right;font-size: 18px;" class="nav-link" href="{{url('frontpage')}}"  >logout</a>
                    </li>
